...
public class ReportJasperPrint {
	...
	private static final String DIR_PATH = "D:/HardCoreCode/workspace-luna/MyReport/src/main/resources";	
	private static final String FONT = "TH SarabunPSK";
	...
	public void print() throws JRException {
		...
		//new ReportGenarater(DIR_PATH+"/PDF").sourceFormatPDF(DIR_PATH + "/jrprint/PrintServiceReport.jrprint");
	...
	public static void main(String[] args) {
		...
		try {
			...
			JRSaver.saveObject(jasperPrint, DIR_PATH + "/PrintServiceReport.jrprint");
			System.err.println("Filling time : " + (System.currentTimeMillis() - start0));
			
			//print
			long start = System.currentTimeMillis();
			new ReportJasperPrint().print();
			System.err.println("Filling time : " + (System.currentTimeMillis() - start));
			
		} catch (JRException e) {
			LOGGER.error("run main error ::", e);
		}
	}
}
